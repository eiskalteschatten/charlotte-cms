...
export default {
  up: async (query: QueryInterface): Promise<void> => {
    await query.bulkInsert('stories', [
      {
        title: 'This is a draft story',
        ...
        note_to_admin: 'This is a note',
        status: 'draft',
        is_erotic: false,
        submission_agreement: false,
        slug: 'this-is-a-draft-story',
        views: 0,
        fk_user: 1,
        updatedAt: new Date(),
        createdAt: new Date(),
      ...
      {
        title: 'This is a published story',
        content: 'I have **some boldness** as well as some *italics* and ** *bold italic* **.',
        short_Description: 'Examples, examples, examples...',
        open_for_comments: true,
        open_for_ratings: true,
        ...
        is_erotic: false,
        submission_agreement: false,
        slug: 'this-is-a-published-story',
        views: 0,
        fk_user: 2,
